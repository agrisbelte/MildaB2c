...
namespace Milda.B2C.Maui.MSALClient
{
    ...
    public class MSALClientHelper
    {
        ...
        {
            this.PublicClientApplicationBuilder = PublicClientApplicationBuilder
        ...
        private async Task<IEnumerable<IAccount>> AttachTokenCache()
        {
            ...
            var appCachePath = Path.Combine(AppContext.BaseDirectory, AzureADB2CConfig.CacheDir);

            // Cache configuration and hook-up to public application. Refer to https://github.com/AzureAD/microsoft-authentication-extensions-for-dotnet/wiki/Cross-platform-Token-Cache#configuring-the-token-cache
            var storageProperties = new StorageCreationPropertiesBuilder(AzureADB2CConfig.CacheFileName, appCachePath)
                .Build();
